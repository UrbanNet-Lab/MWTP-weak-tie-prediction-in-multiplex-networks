...
import numpy as np
class SemanticAttention1(nn.Module):
    def __init__(self, features_num,device, dropout, alpha):
        super(SemanticAttention1, self).__init__()
...
class BitwiseMultipyLogis1(nn.Module):
    def __init__(self, features_num,device):
        super(BitwiseMultipyLogis1, self).__init__()
        self.features_num = features_num
